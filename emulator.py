...
##
font_t = QFont("Bahnschrift", 10, QFont.Bold)
...
class ConnectionDock(QDockWidget):
    ...
    def __init__(self, mc, name, topic_sub, topic_pub):
        ...
        self.eConnectbtn.setStyleSheet("background: qlineargradient(x1:0, y1:0, x2:1, y2:1, stop:0 #ff0000, stop:0.5 #ff4d4d, stop:1 #b30000)")
        ...
        if 'DHT' in self.name: 
            ...
            self.ePushtbtn.setStyleSheet("background: qlineargradient(x1:0, y1:0, x2:1, y2:1, stop:0 #007bff, stop:0.5 #4d8fff, stop:1 #003cb3)")
            self.Temperature=QLineEdit()
            self.Temperature.setText('')   
            formLayot.addRow("Turn On/Off",self.eConnectbtn)
    ...
    def on_connected(self):
        self.eConnectbtn.setStyleSheet("background: qlineargradient(x1:0, y1:0, x2:1, y2:1, stop:0 #00FF00, stop:0.5 #66FF66, stop:1 #00CC00)")
    ...
    def update_btn_state(self,messg):
        ...
        if 'Set' in messg:
            ...
            try:
                ...
                ic("failure in parsing temperature")            
            tmp_upd=tmp
...
class MainWindow(QMainWindow):    
    def __init__(self, args, parent=None):
        ...
        # set up main window
        self.setGeometry(30, 600, 350, 200)
...
if __name__ == '__main__':
    ...
    try:    
        ...
        #
        app.setStyleSheet(Path('clean.css').read_text())
        ...
        #mainwin.setStyleSheet("background-color: #AED6F1;")
